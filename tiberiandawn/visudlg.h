...
private:
    enum VisualControlEnums
    {
        ...
        BUTTON_IPAD_TOUCH_EDGE_SCROLL,
        BUTTON_IPAD_TOUCH_SCROLL_SPEED,
        BUTTON_IPAD_TOUCH_SELECTION_TOLERANCE,
        BUTTON_IPAD_TOUCH_HELP,
        BUTTON_VISION_LOOK_SCROLL,
        BUTTON_VISION_SCROLL_SPEED,
        BUTTON_VISION_EDGE_SENSITIVITY,
        BUTTON_VISION_SELECTION_TOLERANCE,
